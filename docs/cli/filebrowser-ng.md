...
filebrowser-ng CLI lets you create the database to use with filebrowser-ng,
...
```
  ...
  -h, --help                           help for filebrowser-ng
...
* [filebrowser-ng hash](filebrowser-ng-hash.md)	 - Hashes a password
* [filebrowser-ng rules](filebrowser-ng-rules.md)	 - Rules management utility
* [filebrowser-ng users](filebrowser-ng-users.md)	 - Users management utility
* [filebrowser-ng version](filebrowser-ng-version.md)	 - Print the version number
